...
function cl_PProtect.addfrm(w, h, title, hor)
  ...
  function frm.close:Paint()
    if self.Depressed then
      draw.RoundedBox(4, 0, 0, 30, 30, Color(135, 50, 50))
    elseif self.Hovered then
      draw.RoundedBox(4, 0, 0, 30, 30, Color(200, 60, 60))
    else
...
function pan:addico(model, tip, cb)
  ...
  function ico:Paint(w, h)
    ...
    if self.Depressed then
      draw.RoundedBox(4, 0, 0, w, h, Color(0, 0, 0, 63.75))
    end
  end

  function ico:PaintOver()
  end
